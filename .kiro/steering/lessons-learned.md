...
| **问题类型** | **文件** |
|---------|------|
| **历史消息格式处理** | `.kiro/lessons-learned/78_历史消息格式处理策略.md` |
| **OpenAI 兼容 API 格式差异** | `.kiro/lessons-learned/77_OpenAI兼容API格式差异调试方法论.md` |
...
| **LLM 无限循环** | `.kiro/lessons-learned/75_对话历史格式混乱导致LLM行为异常.md` |
| **LLM 行为异常** | `.kiro/lessons-learned/70_LLM行为异常的完整调试流程.md` |
| **对话历史格式混乱** | `.kiro/lessons-learned/75_对话历史格式混乱导致LLM行为异常.md` |
| **格式转换不完整** | `.kiro/lessons-learned/75_对话历史格式混乱导致LLM行为异常.md` |
...
| **LLM 内容违规错误** | `.kiro/lessons-learned/90_LLM内容违规错误处理.md` |
| **API 错误分类** | `.kiro/lessons-learned/90_LLM内容违规错误处理.md` |
...
| **Spec 任务批量执行** | `.kiro/lessons-learned/108_Spec任务批量执行模式.md` |
| **批量任务执行** | `.kiro/lessons-learned/108_Spec任务批量执行模式.md` |
| **跳过测试任务** | `.kiro/lessons-learned/108_Spec任务批量执行模式.md` |
